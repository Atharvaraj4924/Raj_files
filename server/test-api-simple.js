// test-api-simple.js
const https = require('https'); // Use HTTPS for ngrok URLs

// ---------- CONFIG ----------
const API_HOST = 'jesenia-cryptogamic-kylan.ngrok-free.dev'; // <-- replace with your ngrok URL
const API_PORT = 443; // HTTPS port
...
const testAPI = async () => {
  try {
    ...
    if (patientsResponse.data.patients.length > 0) {
      ...
      // Step 3: Test vitals endpoint for first patient
